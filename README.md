<p align="center">
  <img src=".assets/hero_banner.svg" width="100%" height="380" alt="AaruxMusic Animated Neon Audio Engine">
</p>

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=700&size=26&duration=4000&pause=1000&color=00F2FE&center=true&vCenter=true&width=1000&lines=AaruxMusic+Repo+—+Lightning-Fast+Telegram+Music+Streaming!;Ultra-Low+Latency+Audio+%26+HD+Video+Voice+Chat+Engine!;Powered+by+Kurigram+%26+PyTgCalls+•+Developer+Sparrow+Core!">
</div>

---

<p align="center">
  <a href="https://github.com/DevloperSP/AaruxMusic/stargazers"><img src="https://img.shields.io/github/stars/DevloperSP/AaruxMusic?style=for-the-badge&color=2563EB" alt="GitHub Stars"></a>
  <a href="https://github.com/DevloperSP/AaruxMusic/network/members"><img src="https://img.shields.io/github/forks/DevloperSP/AaruxMusic?style=for-the-badge&color=3B82F6" alt="GitHub Forks"></a>
  <a href="https://github.com/DevloperSP/AaruxMusic/blob/main/LICENSE"><img src="https://img.shields.io/github/license/DevloperSP/AaruxMusic?style=for-the-badge&color=10B981" alt="License"></a>
...
<p align="center">
  <a href="https://dashboard.heroku.com/new?template=https://github.com/DevloperSP/AaruxMusic">
...
<summary align="center">
  <b><font color="#7C3AED" size="3">⚡ 𝑽𝒊𝒆𝒘 𝑽𝑷𝑺 𝑫𝒆𝒑𝒍𝒐𝒚𝒎𝒆𝒏𝒕 𝑪𝒐𝒎𝒎𝒂𝒏𝒅𝒔 (Click Here) ⚡</font></b>
</summary>
<br>
...
```bash
git clone https://github.com/DevloperSP/AaruxMusic
```
...
docker build -t AaruxMusic .

# 4. Run Docker container in detached mode
docker run -d --name musicsp_bot --env-file .env AaruxMusic
```
...
```bash
# 1. Clone repository
git clone https://github.com/DevloperSP/AaruxMusic && cd AaruxMusic
...
```mermaid
graph LR
    User([👤 Telegram User / Group]) -->|Commands / Play Request| Bot[🤖 AaruxMusic Bot Core]
...
<p align="center">
  <a href="https://github.com/DevloperSP/AaruxMusic/blob/main/LICENSE">
...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=600&size=17&duration=3800&pause=1000&color=00F2FE&center=true&vCenter=true&width=850&lines=%E2%9C%A8+AaruxMusic+%E2%80%94+Crafted+with+excellence+for+Telegram+voice+%26+video+streaming+communities.;%E2%9A%A1+Fast%2C+Reliable+%26+Secure+%E2%80%94+Join+our+community+%40Mecobots!;%F0%9F%9A%80+Powered+by+Developer+Sparrow+Engine+%E2%80%A2+24%2F7+Lossless+Streaming!">
</div>


## License

This distribution includes the AaruxMusic Custom License. See `LICENSE`.
